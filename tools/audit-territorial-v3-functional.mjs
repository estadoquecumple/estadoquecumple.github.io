...
const implementation=['TerritorialLab.astro','TerritoryMap.astro','RootsWorkspace.astro','SaviaWorkspace.astro','SeedsWorkspace.astro','ScenarioOutputs.astro'].map((file)=>readFileSync(`src/components/territorial/${file}`,'utf8')).join('\n');

...
test('RAÍCES busca municipio nacional, cambia capas, función y comparación',async({page})=>{
...
test('SAVIA declara fuentes manual-required como ausentes',async({page})=>{
  await page.getByRole('button',{name:/SAVIA/}).click(); await page.locator('[data-evaluate]').click();
